    ...
    <>
      ...
      <LegalSection title="Introduction">
        <p>
          ...
          les utilisateurs du site Alvon Digital Group sur la manière dont leurs
          données personnelles sont collectées, utilisées, conservées et
          protégées.
        </p>
        ...
        <p>
          ...
          française en vigueur relative à la protection des données
          personnelles.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Données collectées">
        <p>
          Dans le cadre de l'utilisation du formulaire de contact, nous sommes
          amenés à collecter ces informations :
        </p>
        ...
        <p>Aucune donnée sensible n'est collectée via le site.</p>
      </LegalSection>
      ...
      <LegalSection title="Base légale">
        <p>
          ...
          lors de l'envoi du formulaire de contact, ainsi que sur l'intérêt
          légitime d'Alvon Digital Group à répondre aux demandes reçues.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Durée de conservation des données">
        ...
        <p>
          Elles sont ensuite supprimées ou archivées conformément aux
      ...
      <LegalSection title="Destinataires des données">
        <p>
          Les données collectées sont exclusivement destinées à Alvon Digital
          Group.
        </p>

        <p>
          Elles ne sont ni vendues, ni louées, ni cédées à des tiers, sauf
          obligation légale ou demande émanant d'une autorité compétente.
        </p>
      </LegalSection>

      <LegalSection title="Sécurité">
        <p>
          Alvon Digital Group met en œuvre les mesures techniques et
          organisationnelles nécessaires afin de protéger les données
          personnelles contre toute perte, altération, divulgation ou accès non
          autorisé.
        </p>

        <p>
          Les échanges entre le navigateur de l'utilisateur et le site sont
          sécurisés grâce au protocole HTTPS.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Contact">
        <p>
          ...
          l'exercice de vos droits relatifs à vos données personnelles, vous
          pouvez nous contacter à l'adresse suivante :
        </p>

        <p>
          <strong>Email :</strong> services.client.alvongroup@gmail.com
        </p>
