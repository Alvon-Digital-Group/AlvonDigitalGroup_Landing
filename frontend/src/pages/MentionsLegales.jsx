    ...
    <>
      ...
      <LegalSection title="Éditeur du site">
        <p>
          ...
          agence spécialisée dans le développement de solutions numériques sur
          mesure, notamment la création de sites web, d'applications mobiles et
          l'optimisation de la visibilité en ligne.
        </p>

        <p>Statut juridique : SAS, société par actions simplifiée</p>

        <p>Siège social : 165 rue Becquerel, 59500 Douai, France</p>

        <p>Email : services.client.alvongroup@gmail.com</p>

        <p>Numéro SIRET : 103 919 999 00013</p>
      </LegalSection>
      ...
      <LegalSection title="Hébergement">
        ...
        <p>Adresse : 200 rue de la Croix Nivert, 75015 Paris, France</p>

        <p>Site web : Amen.fr</p>
      </LegalSection>
      ...
      <LegalSection title="Propriété intellectuelle">
        ...
        <p>
          ...
          ou partielle, sans autorisation préalable écrite d'Alvon Digital Group
          est interdite.
        </p>
      </LegalSection>
      ...
      <LegalSection title="Responsabilité">
        ...
        <p>
          Toutefois, l'agence ne peut garantir l'absence d'erreurs, d'omissions
          ou d'interruptions de service et ne pourra être tenue responsable des
      ...
      <LegalSection title="Données personnelles">
        <p>
          ...
          utilisées uniquement dans le cadre du traitement des demandes des
          utilisateurs.
        </p>
